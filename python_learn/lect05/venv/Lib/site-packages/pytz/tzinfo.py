...
class DstTzInfo(BaseTzInfo):
    ...
    def localize(self, dt, is_dst=False):
        ...
        if len(possible_loc_dt) == 0:
            # If we refuse to guess_number, raise an exception.
            if is_dst is None:
        ...
        # At this point, we just have to guess_number unless we allow more
...
def unpickler(zone, utcoffset=None, dstoffset=None, tzname=None):
    ...
    # get changed from the initial guess_number by the database maintainers to
